...
class take_selfieActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = take_selfieGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new take_selfieActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = take_selfieGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new take_selfieGoal()
    }
...
module.exports = take_selfieActionGoal;
